# -*- coding: utf-8 -*-
"""
Created on Tue Apr 20 20:00:21 2021
...
LB = [160000,150,30000,10000, 2000, 10,  500, 100, 0, 0, 0,300, 0,0,0]
UB = [190000,300,60000,30000,10000,2000,5000,1000,100, 0, 5,1000, 300,200,0]
    ##创建GA类实例
GA_model = GA(700,15,30,LB,UB,30,0.9,0.1)
## 初始化种群
...
for i in range(1,GA_model.iter_num):
    ...
    # 在完成计算并记录计算结果后，将父代最好的个体及信息直接赋值给子代最差个体
